...
const MODELS = {
  acquire: {
    ...
    note: "Industry: median 0.82× revenue, 3–4× EBITDA (HealthValue Group)",
  },
  refurb: {
    ...
    note: "EquipmentFinanceHub: $3,437–$8,592/mo at 7.5% APR × 72 months",
  },
  lease: {
    ...
    note: "EquipmentFinanceHub: $12,093–$18,139/mo at 6.5% APR × 84 months",
  },
};
...
const OPX = [
  ...
  { l: "Admin / Front desk × 1.5", lo: 5500, mi: 7000, hi: 9000 },
  { l: "Utilities (MRI power)", lo: 5000, mi: 6500, hi: 9000 },
  { l: "Consumables & contrast", lo: 3000, mi: 5000, hi: 7500 },
  { l: "Insurance", lo: 2000, mi: 3500, hi: 4500 },
  { l: "IT / PACS / RIS", lo: 2000, mi: 3000, hi: 4000 },
...
export default function App() {
  ...
  const calc = useMemo(() => {
    ...
    const day1 = m.down + m.site + m.pacs + m.wc + m.mkt + m.acr;
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", display: "grid", gap: 16 }}>
          ...
          <div style={{ display: "grid", gap: 12, gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))" }}>
            <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 10, padding: 16 }}>
              ...
              {[["Down payment / deposit", m.down], ["Site prep / RF shielding", m.site], ["PACS + IT setup", m.pacs], ["Working capital (3-mo buffer)", m.wc], ["Marketing launch", m.mkt], ["ACR accreditation", m.acr]].map(([l, v], i) => <Row key={i} label={l} value={f(v)} />)}
